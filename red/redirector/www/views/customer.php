<div class="container my-5" id="pageBegin"> 
        ...
        <div class="d-flex justify-content-end">
            <a href="/customer/add" class="btn btn-danger px-5 mx-3" type="submit">Новый оффер</a> 
    ...
    <div class="my-5"> 
        <h4 class="my-3 textalign-left color-brown" id="MyOffers">Активные офферы</h4>  
        ...
        <table class="table table-striped table-hover" id="offerList">
            ...
            <tbody>
                ...
                $offers = $payload['offers']['active'] ?? null; 
                ...
                foreach($offers as $offer) : ?> 
                    ...
                    <tr>                           
                        ...
                        <td>
                            <a href="/customer/edit/<?=$offer['id']?>" id="offerName"> 
                                <?=$offer['name']?>
                            </a>                                    
                        </td>
                        <td>
    ...
    <div class="my-5"> 
        <h4 class="my-3 textalign-left color-brown" id="MyOffers">Архив</h4>  
